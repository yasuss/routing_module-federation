import { TrailingSlashMode, QueryParamsMode, QueryParamsOptions, RouteNode, RouteNodeState, URLParamsEncodingType } from 'route-node';
...
export declare type ActivationFn = (toState: State, fromState: State, done: DoneFn) => boolean | Promise<boolean> | void;
export declare type ActivationFnFactory<Dependencies extends DefaultDependencies = DefaultDependencies> = (router: Router, dependencies?: Dependencies) => ActivationFn;
export declare type DefaultDependencies = Record<string, any>;
...
export declare type Middleware = (toState: State, fromState: State, done: DoneFn) => boolean | Promise<any> | void;
export declare type MiddlewareFactory<Dependencies extends DefaultDependencies = DefaultDependencies> = (router: Router, dependencies: Dependencies) => Middleware;
export declare type PluginFactory<Dependencies extends DefaultDependencies = DefaultDependencies> = (router?: Router, dependencies?: Dependencies) => Plugin;
