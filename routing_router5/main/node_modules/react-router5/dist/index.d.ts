...
declare const Router: import("react").Consumer<import("router5").Router<Record<string, any>>>;
declare const Route: import("react").Consumer<import("./types").RouteContext>;
export { RouterProvider, BaseLink, ConnectedLink, Link, withRouter, withRoute, routeNode, Router, Route, RouteNode, useRouter, useRoute, useRouteNode };
