...
function withRoute(BaseComponent) {
    return function withRoute(props) {
        return (React__default.createElement(routeContext.Consumer, null, function (routeContext) { return React__default.createElement(BaseComponent, __assign({}, props, routeContext)); }));
    };
}
...
var RouteNode = function (props) {
    return (React__default.createElement(routeContext.Consumer, null, function (routeContext) { return React__default.createElement(RouteNodeRenderer, __assign({}, props, routeContext)); }));
};
