...
var buildPathFromSegments = function buildPathFromSegments(segments, params, options) {
  ...
  if (queryParamsMode === 'loose') {
    var extraParams = Object.keys(params).reduce(function (acc, p) {
      return searchParams$1.indexOf(p) === -1 && nonSearchParams.indexOf(p) === -1 ? acc.concat(p) : acc;
    }, []);
...
function () {
  ...
  RouteNode.prototype.add = function (route, cb, sort) {
    ...
    if (!(route instanceof RouteNode) && !(route instanceof Object)) {
      ...
      if (cb) {
        cb(tslib.__assign(tslib.__assign({}, route), {
          name: fullName
        }));
      }
...
//# sourceMappingURL=route-node.cjs.development.js.map
